...
class PlayerIoTest < Minitest::Test
  ...
  def test_export_method_writes_a_new_txt_file_with_correct_output
    ...
    assert_equal 'Abercrombie Neil Male 2/13/1943 Tan', output_file[23].strip
    assert_equal 'Bishop Timothy Male 4/23/1967 Yellow', output_file[24].strip
    assert_equal 'Bonk Radek Male 6/3/1975 Green', output_file[25].strip
    assert_equal 'Bouillon Francis Male 6/3/1975 Blue', output_file[26].strip
    assert_equal 'Hingis Martina Female 4/2/1979 Green', output_file[27].strip
    assert_equal 'Kelly Sue Female 7/12/1959 Pink', output_file[28].strip
    assert_equal 'Kournikova Anna Female 6/3/1975 Red', output_file[29].strip
    assert_equal 'Seles Monica Female 12/2/1973 Black', output_file[30].strip
    assert_equal 'Smith Steve Male 3/3/1985 Red', output_file[31].strip
  end
